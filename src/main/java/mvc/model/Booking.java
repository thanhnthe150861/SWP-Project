...
public class Booking {
    ...
    public Booking(int id, int doctor_id, int patient_id, String booking_reason, Date date, int slot_id, String status, String reason, Doctor doctor, Patient patient, Slot slots) {
        this.id = id;
